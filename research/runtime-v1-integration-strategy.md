...
- Guarded per-agent canary switch tooling and exact rollback restore support merged after that baseline; **Pi Runtime v1 decision** workflow run `25969043105` passed again on `main`.
