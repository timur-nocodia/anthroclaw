...
- Remaining Ring 3 expanded product surfaces have not started: external MCP onboarding, scheduled Buildroom, and broader plugin/MCP/cron combinations.
...
| 7. Default-runtime rollout | In progress | Flip runtime default safely. | Default flip is merged into `main`; post-merge local, durable, live pull, safe Web UI, extended monitoring, Ring 1, Ring 2, Ring 3.1 learning review, Ring 3.2 session continuity, and Ring 3.3 plugin context are green; remaining Ring 3+ expansion remains. |
...
1. Choose the next Ring 3 surface: external MCP onboarding or scheduled Buildroom.
...
Ring 1 is closed by operator acceptance after green live-channel and monitor evidence. Ring 2 is closed after the low-risk normal-operation window and post-window monitor. Ring 3.1 learning review, Ring 3.2 session continuity, and Ring 3.3 plugin context are closed. Default Pi is no longer evidence-blocked; the next gate is another targeted Ring 3 expanded product surface.
